  ...
  return (
    <div className="flex items-center justify-center gap-3 flex-col w-full">
      ...
      <div className="flex items-center justify-evenly w-full gap-3">
        <div className="border border-green-500 py-2 w-[120px]  lg:w-36 flex items-center justify-center rounded-md flex-col gap-1">
          <div className="font-medium ">Correct</div>
          <div className="font-bold lg:text-3xl text-green-500">
            {stats?.correct_options}
          </div>
        </div>
        <div className="border border-red-500 py-2 w-[120px]  lg:w-36 flex items-center justify-center rounded-md flex-col gap-1">
          <div className="font-medium ">Incorrect</div>
          <div className="font-bold lg:text-3xl text-red-500">
            {stats?.incorrect_options}
          </div>
        </div>
        <div className="border border-neutral-500 py-2 w-[120px]  lg:w-36 flex items-center justify-center rounded-md flex-col gap-1">
