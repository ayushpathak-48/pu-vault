import { MATERIAL_LINK_BASE_URL_SEM_4 } from "..";

export const sem4Materials = [
  // MAD
  {
    id: 1,
    subject_name: "Project Guidelines and Front Pages",
    key: "project-guidelines-and-front-pages",
    syllabus_link: ``,
    notes_link: [
      {
        id: 1,
        title: "Index",
        href: `${MATERIAL_LINK_BASE_URL_SEM_4}/materials/index.docx`,
      },
      {
        id: 2,
        title: "Certificate",
        href: `${MATERIAL_LINK_BASE_URL_SEM_4}/materials/certificate-final.docx`,
      },
      {
        id: 3,
        title: "Home Page",
        href: `${MATERIAL_LINK_BASE_URL_SEM_4}/materials/home-page.docx`,
      },
      {
        id: 4,
